...
export default function Footer() {
  return (
    <footer className="bg-brand-950 text-brand-300 mt-0">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-8 mb-10">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-3">
              ...
              <div>
                <div className="text-white font-extrabold text-sm">IndemnityInsurance.co.nz</div>
              </div>
            </div>
            <p className="text-sm text-brand-400 leading-relaxed mb-4 max-w-xs">
            ...
            <p className="text-xs text-brand-500">
              <Link href="mailto:hello@cover4you.co.nz" className="hover:text-brand-300">hello@cover4you.co.nz</Link>
            </p>
          </div>
        ...
        <div className="border-t border-brand-800 pt-8">
          <div className="flex flex-wrap gap-4 text-xs text-brand-500 mb-4">
            <Link href="/privacy/" className="hover:text-brand-300">Privacy Policy</Link>
            <Link href="/terms/" className="hover:text-brand-300">Terms of Use</Link>
            <Link href="/disclaimer/" className="hover:text-brand-300">Disclaimer</Link>
          </div>
          <p className="text-xs text-brand-500 leading-relaxed max-w-4xl">
            <strong className="text-brand-400">Disclaimer:</strong> IndemnityInsurance.co.nz is an information and referral service. We are not a licensed insurer or financial adviser. The insurance advisers we refer you to are independently licensed under the Financial Markets Conduct Act 2013. Insurance products are subject to policy terms, conditions and exclusions. Coverage information on this site is general in nature and does not constitute financial advice. Please read your policy document carefully.
          </p>
