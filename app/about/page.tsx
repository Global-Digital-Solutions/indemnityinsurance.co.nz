        ...
        <div className="prose max-w-none space-y-8">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-8">
            ...
            <ul className="space-y-3 text-slate-700 mb-4">
              <li><strong className="text-slate-900">We publish what the rules require, and where they require nothing.</strong> A great deal of what is written about indemnity insurance claims that professions are required to hold it when no rule says any such thing. We have documented where that is wrong, profession by profession, with the source. That is a statement about the rules and not about any reader&rsquo;s business — cover is widely held and often sensible even where nothing compels it. Whether it is right for you is a question for a licensed broker.</li>
