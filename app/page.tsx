          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="inline-block bg-orange-500/20 border border-orange-400/40 text-orange-400 text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-full mb-6">
                Plain English, with the source
              </span>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight mb-6">
                Indemnity Insurance,<br />
                <span className="text-orange-400">Explained Honestly</span>
              </h1>
...
A lot of people are told they must hold indemnity insurance when no rule says anything of the sort. So we start with the truth about your profession, and we show you where it comes from — including when the honest answer is that nothing requires you to hold it at all. If cover does make sense for you, we will put you in touch with a local broker who knows your trade and will talk to you like a person. That is the whole of it.
      ...
      <div className="py-16 bg-brand-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-brand-300 max-w-xl mx-auto">Four steps, no pressure at any of them. You can stop after any one.</p>
          </div>
      ...
      <div className="py-16 bg-gradient-to-br from-brand-900 to-brand-800">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-brand-500 text-xs mt-4">No spam, no hard sell, no obligation. Local brokers only.</p>
        </div>
      </div>
    </div>
  )
